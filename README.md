...
For the latest version that integrates the NeuroSim with Tensorflow and PyTorch for a flexible neural network topology (instead of the fixed MLP for MNIST dataset in this current version), please go to DNN+NeuroSim V1.0 (https://github.com/neurosim/DNN_NeuroSim_V1.0).
